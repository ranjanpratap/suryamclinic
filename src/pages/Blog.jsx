...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen bg-[#f9f1da]" ref={heroRef}>
                ...
                >
                  ...
                  <div className="flex flex-col gap-2.5 p-6 flex-1">
                    ...
                    <div className="flex items-center gap-2.5 mt-3 pt-3 border-t border-black/5">
                      ...
                      <p className="text-black/50 text-[12px] font-medium flex-1 truncate">{blog.author}</p>
      ...
      <div className="relative overflow-hidden bg-[#29abe2] py-24 px-6">
        {/* Texture overlay */}
        <div
          className="absolute inset-0 mix-blend-color-burn opacity-75 pointer-events-none"
          style={{ backgroundImage: `url(${A.texture || A.footerTexture})`, backgroundSize: '2048px 2048px', backgroundPosition: 'top left' }}
        />

        <div className="relative z-10 max-w-[700px] mx-auto text-center flex flex-col items-center gap-5">
