...
const IMGS = [A.img1208, A.img1209, A.img1210, A.img1211, A.img1212, A.img1208, A.img1209, A.img1210, A.img1211, A.img1212, A.img1208, A.img1209]

const ROWS = [
  [...IMGS],
  [...IMGS].reverse(),
  [...IMGS].map((_, i, a) => a[(i + 3) % a.length]),
  [...IMGS].map((_, i, a) => a[(i + 7) % a.length]),
]
  ...
  return (
    <section ref={ref} id="gallery" className="py-0 overflow-hidden">
      <div className="relative bg-[#29abe2] overflow-hidden pt-16 pb-20">
        ...
        {/* Wave top flipped */}
        <img src={A.wave1} alt="" className="absolute top-0 left-0 w-full h-auto pointer-events-none select-none" style={{ transform: 'scaleY(-1)' }} />
