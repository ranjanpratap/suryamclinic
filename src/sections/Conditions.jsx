...
export default function Conditions() {
  ...
  return (
    <section ref={ref} id="conditions" className="py-20 px-6">
          ...
          {CONDITIONS.map((c) => (
            ...
            >
              ...
              <div className="flex items-center gap-1 mt-4">
                ...
                <img src={A.arrowR2} alt="" className="w-5 h-5 object-contain group-hover:translate-x-1 transition-transform duration-200" />
              </div>
            </div>
          ))}
        </div>
