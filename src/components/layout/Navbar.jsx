...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-[60] flex items-center justify-between px-6 lg:px-16 py-4 transition-all duration-300 ${
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <ButtonPrimary icon={A.call2} className="shadow-md font-normal hidden sm:flex">
            Book Call
          </ButtonPrimary>
      ...
      >
         ...
         <div className="mt-auto pb-16 flex flex-col gap-4">
            ...
            <p className="text-[20px] font-bold text-black">+91 98765 43210</p>
